      ...
      <div className="w-full max-w-md my-auto rounded-2xl border border-slate-800 bg-slate-900/80 backdrop-blur-md p-8 shadow-2xl z-10 relative overflow-hidden">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-slate-400 font-mono">
            Únete a Mundo Store para gestionar pedidos y favoritos.
          </p>
        </div>
        ...
        {success && (
          <div className="mt-5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 p-3.5 text-xs font-mono text-emerald-400 flex items-center gap-2">
